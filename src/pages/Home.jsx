...
function Home() {
  ...
  const [fillStrategy, setFillStrategy] = useState('zero');
  ...
  const onCleanData = () => {
    ...
    cleanCSV({ formData, fillStrategy });
  };
    ...
    <section className='flex-col space-y-7 py-8 tablet:py-12 desktop:py-16 px-10 tablet:px-16 desktop:px-24 w-full'>
      ...
      {!selectedFile ? (
        ...
        <section className='flex-col space-y-9'>
          ...
          <aside className='flex flex-wrap gap-4 justify-between'>
            <div className='flex gap-4 items-center'>
              <label
                htmlFor='fill-strategy'
              ...
              <select
                id='fill-strategy'
                className='bg-gray-700 border border-gray-600 text-textPrimary text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-36 p-2.5'
                value={fillStrategy}
                onChange={onSelectFillStrategy}
              >
                {['forward', 'backward', 'zero', 'min', 'max'].map((opt) => (
            ...
            <div className='flex gap-4'>
              ...
              {step === 2 && (
                ...
                >
                  {(isCreating || isCleaning) && <Spinner />}
                  {!isCreating && !isCleaning && (
                    <span className='font-inter text-white text-nowrap'>
                      Create Report
                    </span>
                  )}
