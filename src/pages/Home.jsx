...
function Home() {
  ...
  const report_data = [
    ...
    {
      id: 9,
      name: "Student Engagement and Interaction Metrics",
      date: "04-25-2024",
    },
    ...
    <section className="flex-col space-y-[72px] mt-1">
      <section className="flex-col space-y-7 w-full">
        ...
        <Button
          ...
          style="w-full bg-colorSecondary rounded-xl grid-cols-1 justify-items-center h-64 text-textSecondary"
        >
          <img
          ...
          <p className="font-inter">
            <strong>Click to upload </strong>or drag and drop <br></br>CSV or
            XLS File
          </p>
        </Button>
        <input
